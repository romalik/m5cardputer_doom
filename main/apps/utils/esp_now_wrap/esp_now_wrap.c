...
static const char *TAG = "espnow wrap";
...
static int _received_message_size = 0;
static uint8_t* _received_message;
                                       ...
                                       size_t size, wifi_pkt_rx_ctrl_t *rx_ctrl)
{
    ...
    memcpy(_received_message, data, size);
...
{
    _received_message = ESP_CALLOC(1, ESPNOW_DATA_LEN);
